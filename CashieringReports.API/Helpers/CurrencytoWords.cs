...
namespace CashieringReports.API.Helpers
{
    public class CurrencytoWords
    {
        ...
        private static String ConvertToWords(String numb)
        {
            ...
            String endStr = "Rupees Only"; //rupee only
            try
            {
                ...
                if (decimalPlace > 0)
                {
                    ...
                    if (Convert.ToInt32(points) > 0)
                    {
                        ...
                        endStr = "Cents Only";//Cents    
                        //pointStr = ConvertDecimals(points);
                        pointStr = ConvertWholeNumber(points);
                        
                    }
                }
                string wholeNum = ConvertWholeNumber(wholeNo).Trim();
                if (wholeNum == "") { andStr = "Zero Rupees and"; }
        ...
        public string CurrencyConvertToWords(decimal InNummber)
        {
            string isNegative = "";
            try
            {
                ...
                string number = InNummber.ToString("F");
